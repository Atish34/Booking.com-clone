...
import { useAdminBlockUnblockOwnerMutation, useAdminGetOwnerQuery } from '../../redux/api/adminApi'
import { toast } from 'react-toastify'
import { Spinner } from 'react-bootstrap'

const Owner = () => {
 const {data,isSuccess,isLoading} = useAdminGetOwnerQuery()
   const [updateAdmin,{isSuccess:updateSuccess,isError,error}] = useAdminBlockUnblockOwnerMutation()
