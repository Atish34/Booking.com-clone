...
import { useAdminBlockUnblockCustomerMutation, useAdminGetCustomerQuery } from '../../redux/api/adminApi'
import { toast } from 'react-toastify'
import { Spinner } from 'react-bootstrap'

const Users = () => {
  const {data,isSuccess,isLoading} = useAdminGetCustomerQuery()
  const [updateAdmin,{isSuccess:updateSuccess,isError,error}] = useAdminBlockUnblockCustomerMutation()
